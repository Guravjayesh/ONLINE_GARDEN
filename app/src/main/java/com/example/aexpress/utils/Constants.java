...
//    public static String API_BASE_URL ="http://192.168.187.205/ecom";

    public static String API_BASE_URL ="http://192.168.59.84/ecom/ecom";

//    public static String API_BASE_URL ="http://192.168.59.84/ecom";

//    public static String API_BASE_URL ="http://192.168.11.84/ecommerce";
    ...
    public static String SHIPPING_URL = API_BASE_URL + "/services/listShipping?q";
